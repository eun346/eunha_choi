...
description: A learning log from building locomotion, grabbing, haptics, world-space UI, and comfort features with Unity’s XR Interaction Toolkit.
tags: [Unity, VR, XR Interaction Toolkit, Meta Quest]
category: Learning Log
draft: false
---

# Introduction
I followed Valem’s 13-part Unity VR series to build a complete interaction baseline with the XR Interaction Toolkit. I tested locomotion, teleportation, grabbing, haptics, world-space UI, and comfort settings on a Meta Quest 2. This note records the setup choices and the problems I had to debug.
...
## Video Breakdown
- Videos 1–2: VR overview and Unity setup
- Video 3: Hand models and input
- Video 4: Continuous movement and turning
- Video 5: Teleportation
- Video 6: Hover, grab, and interactable objects
- Video 7: Offset grab and distance grab
- Video 8: VR UI
- Video 9: Haptics
- Videos 10–11: Grab poses
- Video 12: Tunneling vignette for comfort
- Video 13: Example project overview
...
- building interactive world-space UI  
- adding continuous locomotion and snap turning  
- configuring a tunneling vignette as a comfort option  
...
Teleportation was the most comfortable locomotion option in my tests, so I paid close attention to its targeting and orientation behavior.
...
I had to manage interaction layers carefully so the ray did not grab UI or teleport surfaces unintentionally.
...
Haptics made interactions feel more responsive in my tests.
...
Custom grab poses aligned the hands more naturally with tools and weapons.
...
This can reduce discomfort for some users by limiting peripheral motion during movement.
...
**Fix:** Tested on another PC and updated the GPU drivers and Meta Quest Link app.

## 3. Input Misconfiguration
**Issue:** Trigger / grip inputs not firing correctly.  
**Fix:** Rebuilt the Input Action asset and corrected the bindings.
