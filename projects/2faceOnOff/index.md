...
This in-progress experiment explores how face-detection input can control a simple interface state in real time. I am keeping it as an experimental project while I document the detection library, interaction behavior, and results.
